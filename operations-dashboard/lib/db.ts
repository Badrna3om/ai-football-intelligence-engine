...
export async function getContentJobs(limit=80){return rest<ContentJobRow[]>("beskot_content_jobs",{select:"id,job_key,game_id,competition_name,scope_type,content_type,template_key,status,priority,attempts,max_attempts,error_message,created_at,updated_at,rendered_at,published_at",order:"id.desc",limit:String(limit)});}
